...
public class AirControlTest extends TestCase {
    ...
    public void testIntersectExtraCase()
    {
        ...
        WorldDB w = new WorldDB(rnd);
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 0 1 1):\r\n"
                + "1 nodes were visited in the bintree\r\n",
            w.intersect(0, 0, 0, 0, 1, 1));
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 1 1 0):\r\n"
                + "1 nodes were visited in the bintree\r\n",
            w.intersect(0, 0, 0, 1, 1, 0));
        assertFuzzyEquals(
            "The following objects intersect (0 0 0 1 0 1):\r\n"
                + "1 nodes were visited in the bintree\r\n",
            w.intersect(0, 0, 0, 1, 0, 1));
    }
    /**
